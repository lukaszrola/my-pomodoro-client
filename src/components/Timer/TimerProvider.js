...
const timerPanel = (props) => {
    ...
    return (
        <div>
            ...
            <div className={"m-2"}>
                <button type="button" className="btn btn-secondary btn-lg m-4" onClick={()=>runPomodoroWithNMinutes(5)}>5 minutes</button>
                <button type="button" className="btn btn-secondary btn-lg m-4" onClick={()=>runPomodoroWithNMinutes(25)}>25 minutes</button>
                <button type="button" className="btn btn-secondary btn-lg m-4" onClick={()=>runPomodoroWithNMinutes(5)}>45 minutes</button>
            </div>
            <div>
                <form className="d-flex justify-content-center input-group" onSubmit={() => props.handleSubmit()}>
                    ...
                    <input type="submit" className="btn btn-primary btn-lg" value="START POMODORO" />
                </form>
            </div>
        </div>)
}
